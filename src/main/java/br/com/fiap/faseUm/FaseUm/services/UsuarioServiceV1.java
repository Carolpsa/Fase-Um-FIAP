...
public class UsuarioServiceV1 {
    ...
    public UsuarioServiceV1(UsuarioRepository usuarioRepository) {
        this.usuarioRepository = usuarioRepository;
    }

    public List<UsuarioResponseDTOV1> findAllUsuarios(int page, int size) {
    ...
    public Optional<UsuarioResponseDTOV1> findUsuarioById(Long id) {
    ...
    public void saveUsuario(UsuarioRequestDTOV1 usuarioRequestDTO) {
    ...
    public void updateUsuario(UsuarioRequestDTOV1 usuarioRequestDTO, Long id) {
        var optional = this.usuarioRepository.findByEmail(usuarioRequestDTO.email());
    ...
    public void updateSenhaUsuario(UsuarioRequestDTOV1 usuarioRequestDTO, Long id) {
        var usuario = this.usuarioRequest(usuarioRequestDTO);
    ...
    public List<UsuarioResponseDTOV1> findUsuarioByName(String nome, int page, int size) {
        int offset = (page - 1) * size;
        return this.usuarioRepository.findByNameList(nome, size, offset).stream().map(this::response).toList();
    }

    private UsuarioResponseDTOV1 response(Usuario usuario){
        return new UsuarioResponseDTOV1(
            usuario.getId(),
            usuario.getNome(),
            usuario.getEmail(),
            usuario.getLogin(),
    ...
    private Usuario usuarioRequest (UsuarioRequestDTOV1 usuarioRequestDTO){
